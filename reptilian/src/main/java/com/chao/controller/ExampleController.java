 ...
 * @author: luffy 
 * @date: 2018年8月7日 下午2:55:16 
 */
package com.chao.controller;

import com.chao.main.ExampleCrawler;
...
public class ExampleController {
	 public static void main(String[] args) throws Exception {
	         ...
	         */
	        controller.addSeed("https://www.bjsxt.com/");
	 
	        /*
	         * 启动爬虫，爬虫从此刻开始执行爬虫任务，根据以上配置
	         */
	        controller.start(ExampleCrawler.class, numberOfCrawlers);
	    }
